...
classdef MixtureModel
    ...
    methods
        ...
        function [fp, fn, pairwise, n] = estimateErrorRates(self, b)
            ...
            %   are:
            %       fp(i), fn(i):   estimated fraction of false
            %                       positives/negatives for cluster i.
            %       pairwise(i, j): estimated number of spikes that were
            %                       generated by cluster i and (potentially
